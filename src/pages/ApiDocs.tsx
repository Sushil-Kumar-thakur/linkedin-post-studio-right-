...
const PROJECT_URL = "https://krdehujxbhlmpifpjprr.supabase.co";
...
const endpoints: EndpointDoc[] = [
  {
    ...
    parameters: [
      ...
      },
      {
        ...
        type: "string",
        required: false,
        description: "Desired voice tone",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Webhook endpoint for receiving AI-generated posts (API key required)",
    auth: "api-key",
    parameters: [
      {
        name: "posts",
        type: "array",
        required: true,
        description: "Array of generated post objects",
      },
      {
        name: "session_id",
        type: "string",
  ...
  },
  {
    ...
    description:
      "Webhook endpoint for receiving AI-analyzed company profile data",
    auth: "api-key",
    parameters: [
      {
        name: "companyName",
      ...
      },
      {
        ...
        type: "string",
        required: true,
        description: "Company profile ID to update",
      },
      {
        name: "businessOverview",
        type: "string",
        required: false,
        description: "Business overview content",
      },
      {
        name: "valueProposition",
        type: "string",
        required: false,
        description: "Value proposition content",
      },
      {
        name: "idealCustomerProfile",
        type: "string",
        required: false,
        description: "Ideal customer profile content",
      },
    ],
              ...
              <div className="container mx-auto p-6 max-w-6xl">
                <div className="mb-8">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    authentication, parameters, and examples.
                  </p>
                </div>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mb-2">
                        Used for user-authenticated endpoints. Obtain from
                        Supabase auth.
                      </p>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mb-2">
                        Used for webhook endpoints. Configure API keys in admin
                        settings.
                      </p>
                      <code className="text-sm bg-muted px-2 py-1 rounded block">
